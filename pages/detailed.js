...
import { CalendarOutlined, FolderOutlined, FireOutlined, ToTopOutlined } from '@ant-design/icons';
...
Detailed.getInitialProps = async (context) => {
    ...
    const isSuccess = await axios(servicePath.setListViewCountById + id).then(res => res.data.isScuccess)
